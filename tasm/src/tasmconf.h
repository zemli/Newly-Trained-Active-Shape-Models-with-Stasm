...
static const int TASM_1D_PROFLEN = 11;
...
static const int TASM_NNEG_TRAIN_DESCS = 4; // nbr of neg descs per landmark per shape
static const int TASM_NEG_MIN_OFFSET = 1;   // min x or y displacement of a neg desc
static const int TASM_NEG_MAX_OFFSET = 8;   // max x or y displacement of a neg desc

static const int TASM_NEGTRAIN_SEED = 2016; // seed for random generation of neg offsets
